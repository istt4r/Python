            ...
            try:
                with open(path, 'r', encoding='utf-8') as f:
                    ...
                    if date_match:
                        ...
                        session_match = re.search(r'(back|biceps|chest|deltoid|forearm|triceps|abdominals|legs one|legs two|push one|push two|pull one|pull two|legs 1|legs 2|push 1|push 2|pull 1|pull 2)', path.name, re.IGNORECASE)
